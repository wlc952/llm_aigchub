...
def launch(model_path, tokenizer_path, temperature, top_p, repeat_penalty, repeat_last_n, max_new_tokens, generation_mode, prompt_mode):
    ...
    model_path = f"{llm_dir}/bmodels/{model_path}.bmodel"
...
with gr.Blocks() as demo:
    ...
    model_path = gr.Dropdown(
        label="Model",
        choices=["phi3-4b_int4_1dev", "qwen1.5-1.8b_int8_1dev_seq1280", "qwen2.5-7b_int4_seq8192_1dev"],
        value="qwen1.5-1.8b_int8_1dev_seq1280"
    )
